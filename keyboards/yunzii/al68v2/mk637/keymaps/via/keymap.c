...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
		KC_GRV,	 KC_BRID,   KC_BRIU, LGUI(KC_TAB), 	KC_MYCM, 	KC_MAIL,   KC_WHOM, 	KC_MPRV, 	KC_MPLY, KC_MNXT,   KC_MUTE, 	KC_VOLD, 	 KC_VOLU  ,	KC_SHUTRGB, _______,
	...
	[3] = LAYOUT(
		KC_GRV,	 KC_BRID,   KC_BRIU, 	 LCTL(KC_UP),   KC_Lpad, 	 _______,   _______, 	KC_MPRV, 	KC_MPLY, KC_MNXT,  KC_MUTE, 	KC_VOLD, 	 KC_VOLU  ,	KC_SHUTRGB,  _______,
		_______,	KC_BLE1,	KC_BLE2, 	KC_BLE3, 	KC_24G, 	_______, 	_______, 	_______, 	_______, _______, 	_______, 	_______, 	_______, 	RM_NEXT,  _______,
	...
	[4] = LAYOUT(
		KC_ESC,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,  	KC_F11,  	KC_F12,  	KC_BSPC,  ENC_TG,
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    	KC_LBRC, 	KC_RBRC, 	KC_BSLS,KC_DELETE,
		KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, 	KC_QUOT,    KC_ENT,     KC_PAGE_UP,
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, 	KC_RSFT,    KC_UP,   KC_PAGE_DOWN,
	...
	[5] = LAYOUT(
		KC_GRV,	  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,	_______, 	 _______  ,	KC_SHUTRGB, _______,
		_______, KC_BLE1, KC_BLE2, 	KC_BLE3,KC_24G,  _______, _______, 	_______, _______, _______, 	_______, 	_______, 	_______, 	RM_NEXT,     _______,
		_______, 	KC_MACMODE, 	_______, 	_______, 	_______, 	_______,	_______, 	_______, 	_______, KC_LOCK, 	_______, 	_______, 	RM_HUEU,   KC_VAL_UP, 
		_______, 	_______, 	_______,  	_______,   _______,	  _______, 	_______, 	_______, 	_______, 	_______, 	_______,    _______,   RM_VALU,  KC_VAL_DN,
		_______, 	KC_WIN, 	_______,					KC_RESET,    	                      _______, 	KC_BAT,	RM_SPDD,	RM_VALD, RM_SPDU  , _______
